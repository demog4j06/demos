    ...
    $.getJSON("demos.json", function(data){
        for (var i = 0; i < data.demos.length; i++) {
            ...
            $(item).click(function(){
                ...
                $('.demo-block').show().html('<div class="close">྾</div><iframe src="https://play.8provider.com/game/fullstate/html5/evoplay/' + gamenameurl + '/?project=5725&user_id=30661313&demo=0&wid=1&s=752b016a5bb3d5b33bee9e2000b5580e"/>');
